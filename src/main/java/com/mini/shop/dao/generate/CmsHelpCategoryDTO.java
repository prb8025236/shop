...
public class CmsHelpCategoryDTO implements Serializable {
    private Long id;
     ...
     * This enum corresponds to the database table cms_help_category
     *
     * @mbg.generated
    ...
    public enum Column {
        ...
        helpCount("help_count", "helpCount", "INTEGER", false),
