...
public class CmsTopicCategoryDTO implements Serializable {
    private Long id;
     ...
     * This enum corresponds to the database table cms_topic_category
     *
     * @mbg.generated
    ...
    public enum Column {
        ...
        subjectCount("subject_count", "subjectCount", "INTEGER", false),
