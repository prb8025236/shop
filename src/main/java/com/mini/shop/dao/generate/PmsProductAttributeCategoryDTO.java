...
public class PmsProductAttributeCategoryDTO implements Serializable {
     ...
     * This enum corresponds to the database table pms_product_attribute_category
     *
     * @mbg.generated
    ...
    public enum Column {
        ...
        attributeCount("attribute_count", "attributeCount", "INTEGER", false),
        paramCount("param_count", "paramCount", "INTEGER", false);
