...
public class PmsProductCategoryAttributeRelationDTO implements Serializable {
    private Long id;
     ...
     * This enum corresponds to the database table pms_product_category_attribute_relation
     *
     * @mbg.generated
    ...
    public enum Column {
        ...
        productAttributeId("product_attribute_id", "productAttributeId", "BIGINT", false);
