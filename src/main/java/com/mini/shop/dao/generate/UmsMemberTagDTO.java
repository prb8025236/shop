...
public class UmsMemberTagDTO implements Serializable {
    private Long id;
     ...
     * This enum corresponds to the database table ums_member_tag
     *
     * @mbg.generated
    ...
    public enum Column {
        ...
        finishOrderCount("finish_order_count", "finishOrderCount", "INTEGER", false),
        finishOrderAmount("finish_order_amount", "finishOrderAmount", "DECIMAL", false);
